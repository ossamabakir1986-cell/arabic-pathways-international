const CACHE='arabic-pathways-intl-v0.2.2';
const ASSETS=['./','index.html','app.css?v=0.2.2','config.js?v=0.2.2','app.js?v=0.2.2','course-data.js?v=0.2.2','manifest.webmanifest','icons/icon.svg'];
